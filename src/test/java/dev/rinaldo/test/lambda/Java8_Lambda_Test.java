...
public class Java8_Lambda_Test extends RinaldoDevTest {
    ...
    public void test2() {
        ...
        listaDeNumeros.stream().forEach(numero -> System.out.print(numero));
    ...
    public void test3() {
        ...
        listaDeNumeros.stream().filter(numero -> numero % 2 == 0).forEach(numero -> System.out.print(numero));
//        listaDeNumeros.stream().filter(numero -> numero % 2 == 0).forEach(System.out::print);
